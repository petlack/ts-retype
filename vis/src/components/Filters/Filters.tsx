...
import { Box, Heading, Options, OptionItem, Stack, BoxProps } from '@ts-retype/uikit';
  ...
  return (
    <Stack sx={{ gap: 4 }}>
      <FiltersGroup>
        ...
        <Options name='foo' corners='round' sx={{ gap: 2, overflow: 'hidden' }} onChange={(e) => console.log(e)}>
      ...
      <FiltersGroup>
        ...
        <Options name='foo' corners='round' sx={{ gap: 2, overflow: 'hidden' }}>
